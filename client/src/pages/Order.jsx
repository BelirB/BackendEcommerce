  ...
  return (
    <div className="page-container">
      ...
      {user.cart && (<>
          ...
          <p className="strong">Precio total: $ {cartProducts.reduce((acc, ele)=>acc+ele.quantity*ele.product.price,0).toLocaleString("es-ES", { style: "decimal" })}</p>
        </div>
    ...
    return (
      ...
      <div>
        ...
        <h2 className="strong">Precio total: $ {products.reduce((acc, ele)=>acc+ele.amount,0).toLocaleString("es-ES", { style: "decimal" })}</h2>
      </div>
    </div>
  )}
}
